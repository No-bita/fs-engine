...
class SchemeDocument(BaseModel):
    ...
    eligibility_rules: List[EligibilityRule] = Field(default_factory=list, description="Programmatic rules to determine business eligibility")
    manual_eligibility_rules: List[str] = Field(default_factory=list, description="Manually added, plain-English eligibility rules")
